...
const { omit } = lodash
import { GraphqlDocument, OmitDocument } from '@repo/appwrite-types'
import { appwriteKeys } from './appwriteKeys'

export const transformAppwriteDocumentsIntoGraphqlDocuments = <
	TDocument extends Models.Document,
>(
	...documents: TDocument[]
) => {
