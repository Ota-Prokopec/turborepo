import { c as create_ssr_component, h as add_attribute, l as compute_slots, a as compute_rest_props, b as spread, d as escape_attribute_value, e as escape_object, g as escape, v as validate_component, n as null_to_empty } from "./ssr.js";
...
const Text = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${((tag$1) => {
    return tag$1 ? `<${tag}${add_attribute("class", twMerge("break-normal text-black dark:text-white", className), 0)}>${is_void(tag$1) ? "" : `${slots.default ? slots.default({}) : ``}`}${is_void(tag$1) ? "" : `</${tag$1}>`}` : "";
  })(tag)}`;
});
const css = {
