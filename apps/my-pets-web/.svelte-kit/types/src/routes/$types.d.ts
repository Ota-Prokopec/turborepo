...
type LayoutRouteId = RouteId | "/(app)/(pets)" | "/(app)/(pets)/[petId]" | "/(app)/(pets)/[petId]/edit" | "/(app)/(pets)/addpet" | "/(app)/(pets)/notfound" | "/auth" | "/auth/oauth2/failure" | "/auth/oauth2/success" | null
