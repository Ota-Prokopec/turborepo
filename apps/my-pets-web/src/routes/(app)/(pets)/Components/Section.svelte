<script lang="ts">
	...
	import PetAddressItem from './Items/PetAddressItem.svelte'
	import PetAllergensItem from './Items/PetAllergensItem.svelte'
	import PetDescriptionCustomFieldsItem from './Items/PetDescriptionCustomFieldsItem.svelte'
	...
	import PetTreatingItem from './Items/PetTreatingItem.svelte'
...
<Column class="h-auto mobile:w-full w-[500px] justify-center flex items-center pt-10">
	...
	<Column class="w-full">
		{#if isOwner}
			...
			<TagItem tagLinkId={petData.linkId}></TagItem>
		{:else}
			<IFoundPetButton
