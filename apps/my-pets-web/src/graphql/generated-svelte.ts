...
export type Scalars = {
	...
	Topic: {
		input: 'castle' | 'monument' | 'person' | 'animals' | 'hiking'
		output: 'castle' | 'monument' | 'person' | 'animals' | 'hiking'
	}
	Transport: {
		input: 'train' | 'bus' | 'car' | 'walk' | 'bike'
		output: 'train' | 'bus' | 'car' | 'walk' | 'bike'
	}
...
export type CreateAccountQuery = {
	...
	createAccount: {
		...
		prefs: { __typename?: 'UsersPreferences'; mapRange: number; termsAccepted: boolean }
	}
}
...
export type GetAccountQuery = {
	...
	getAccount: {
		...
		_documentId: string
		_createdAt: string
		secondsFromUserCreatedToNow: number
		userId: string
		myId: string
		username: string
		status: boolean
...
export type GetListOfUsersQuery = {
	__typename?: 'Query'
	getListOfUsers: Array<{
		__typename?: 'User'
		_createdAt: string
		_updatedAt: string
...
export type GetUserByMyIdQuery = {
	__typename?: 'Query'
	getUser: {
		__typename?: 'User'
		_permissions: Array<string>
...
export type UpdateProfilePictureQuery = {
	__typename?: 'Query'
...
export type CreateAnonymousSessionQuery = {
	__typename?: 'Query'
	createAnonymousSession: { __typename?: 'Session'; session: string }
}
...
export type LoginViaEmailQuery = {
	__typename?: 'Query'
	logInViaEmail: { __typename?: 'Session'; session: string }
}
...
export type LikeMonumentMutation = {
	__typename?: 'Mutation'
	likeMonument: {
		__typename?: 'MonumentLike'
		_createdAt: string
...
export type GetListOfLikedMonumentCardsQuery = {
	__typename?: 'Query'
	getListOfMonumentLikeDocuments: Array<{
		__typename?: 'MonumentLike'
		_createdAt: string
		_updatedAt: string
		_collectionId: string
		...
		monument: {
			...
			name: string
			about?: string | null
			topics: Array<'castle' | 'monument' | 'person' | 'animals' | 'hiking'>
			placeDetailId: string
			pictureURL: string
			transports: Array<'train' | 'bus' | 'car' | 'walk' | 'bike'>
			...
			question?: {
				...
				pickingAnswers?: Array<string> | null
...
export type CreateMonumentCompletionMutation = {
	__typename?: 'Mutation'
	createMonumentCompletion: {
		__typename?: 'MonumentCompletion'
		_createdAt: string
		_updatedAt: string
		_collectionId: string
...
export type CreateMonumentMutation = {
	__typename?: 'Mutation'
	createMonument: {
		__typename?: 'Monument'
		_createdAt: string
...
export type GetListOfMonumentCardsQueryVariables = Exact<{
	...
	transports?: InputMaybe<
		Array<Scalars['Transport']['input']> | Scalars['Transport']['input']
	>
	name?: InputMaybe<Scalars['String']['input']>
	limit?: InputMaybe<Scalars['Int']['input']>
	userId?: InputMaybe<Scalars['String']['input']>
...
export type GetListOfMonumentCardsQuery = {
	__typename?: 'Query'
	getListOfMonuments: Array<{
		__typename?: 'Monument'
		_createdAt: string
		_updatedAt: string
		_collectionId: string
...
export type GetListOfMonumentsForMapQuery = {
	__typename?: 'Query'
	getListOfMonuments: Array<{
		__typename?: 'Monument'
		_createdAt: string
...
export type GetMonumentCardQuery = {
	__typename?: 'Query'
	getMonument: {
		__typename?: 'Monument'
		_createdAt: string
...
export type AnswerQuestionMutation = {
	__typename?: 'Mutation'
	answerQuestion: { __typename?: 'UsersAnswerToQuestion'; answeredCorrectly: boolean }
}
...
export type CrateTourMutation = {
	__typename?: 'Mutation'
	createTour: { __typename?: 'Tour'; tourName: string }
}
...
export type GetListOfToursQuery = {
	__typename?: 'Query'
	getListOfTours: Array<{
		__typename?: 'Tour'
		_createdAt: string
		_updatedAt: string
		_collectionId: string
		...
		userId: string
		tourName: string
		monumentIds: Array<string>
		monuments: Array<{ __typename?: 'Monument'; pictureURL: string }>
		creator: {
			__typename?: 'User'
			_createdAt: string
			_updatedAt: string
...
export type GetTourQuery = {
	...
	getTour: {
		...
		usersTourCheckpointsCompletionData: Array<{
			__typename?: 'TourCheckpointCompletion'
			_createdAt: string
			_updatedAt: string
			_collectionId: string
...
export type CreateTourCheckpointCompletionMutation = {
	__typename?: 'Mutation'
...
export const createAccount = (
	options: Omit<WatchQueryOptions<CreateAccountQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<CreateAccountQuery> & {
		query: ObservableQuery<CreateAccountQuery, CreateAccountQueryVariables>
	}
> => {
...
export const getAccount = (
	options: Omit<WatchQueryOptions<GetAccountQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<GetAccountQuery> & {
		query: ObservableQuery<GetAccountQuery, GetAccountQueryVariables>
	}
> => {
	const q = client.watchQuery({
		query: GetAccountDoc,
...
export const getListOfUsers = (
	options: Omit<WatchQueryOptions<GetListOfUsersQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<GetListOfUsersQuery> & {
		query: ObservableQuery<GetListOfUsersQuery, GetListOfUsersQueryVariables>
	}
> => {
	const q = client.watchQuery({
...
export const getProfile = (
	options: Omit<WatchQueryOptions<GetProfileQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<GetProfileQuery> & {
		query: ObservableQuery<GetProfileQuery, GetProfileQueryVariables>
	}
> => {
	const q = client.watchQuery({
		query: GetProfileDoc,
...
export const getUserByMyId = (
	options: Omit<WatchQueryOptions<GetUserByMyIdQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<GetUserByMyIdQuery> & {
		query: ObservableQuery<GetUserByMyIdQuery, GetUserByMyIdQueryVariables>
	}
> => {
	const q = client.watchQuery({
...
export const updateProfilePicture = (
	options: Omit<WatchQueryOptions<UpdateProfilePictureQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<UpdateProfilePictureQuery> & {
		query: ObservableQuery<UpdateProfilePictureQuery, UpdateProfilePictureQueryVariables>
	}
> => {
	const q = client.watchQuery({
...
export const createAnonymousSession = (
	options: Omit<WatchQueryOptions<CreateAnonymousSessionQueryVariables>, 'query'>,
): Readable<
...
export const loginViaEmail = (
	options: Omit<WatchQueryOptions<LoginViaEmailQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<LoginViaEmailQuery> & {
		query: ObservableQuery<LoginViaEmailQuery, LoginViaEmailQueryVariables>
	}
> => {
	const q = client.watchQuery({
...
export const logout = (
	options: Omit<WatchQueryOptions<LogoutQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<LogoutQuery> & {
		query: ObservableQuery<LogoutQuery, LogoutQueryVariables>
	}
> => {
	const q = client.watchQuery({
		query: LogoutDoc,
...
export const setSession = (
	options: Omit<WatchQueryOptions<SetSessionQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<SetSessionQuery> & {
		query: ObservableQuery<SetSessionQuery, SetSessionQueryVariables>
	}
> => {
	const q = client.watchQuery({
		query: SetSessionDoc,
...
export const likeMonument = (
	options: Omit<MutationOptions<any, LikeMonumentMutationVariables>, 'mutation'>,
) => {
...
export const getListOfLikedMonumentCards = (
	options: Omit<WatchQueryOptions<GetListOfLikedMonumentCardsQueryVariables>, 'query'>,
): Readable<
...
export const createMonumentCompletion = (
	...
	const m = client.mutate<
		CreateMonumentCompletionMutation,
		CreateMonumentCompletionMutationVariables
	>({
...
export const createMonument = (
	options: Omit<MutationOptions<any, CreateMonumentMutationVariables>, 'mutation'>,
) => {
...
export const deleteMonument = (
	options: Omit<MutationOptions<any, DeleteMonumentMutationVariables>, 'mutation'>,
) => {
...
export const getListOfMonumentCards = (
	options: Omit<WatchQueryOptions<GetListOfMonumentCardsQueryVariables>, 'query'>,
): Readable<
...
export const getListOfMonumentsForMap = (
	options: Omit<WatchQueryOptions<GetListOfMonumentsForMapQueryVariables>, 'query'>,
): Readable<
...
export const getMonument = (
	options: Omit<WatchQueryOptions<GetMonumentQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<GetMonumentQuery> & {
		query: ObservableQuery<GetMonumentQuery, GetMonumentQueryVariables>
	}
> => {
	const q = client.watchQuery({
...
export const getMonumentCard = (
	options: Omit<WatchQueryOptions<GetMonumentCardQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<GetMonumentCardQuery> & {
		query: ObservableQuery<GetMonumentCardQuery, GetMonumentCardQueryVariables>
	}
> => {
	const q = client.watchQuery({
...
export const answerQuestion = (
	options: Omit<MutationOptions<any, AnswerQuestionMutationVariables>, 'mutation'>,
) => {
...
export const getSystemHealthStatus = (
	options: Omit<WatchQueryOptions<GetSystemHealthStatusQueryVariables>, 'query'>,
): Readable<
...
export const crateTour = (
	options: Omit<MutationOptions<any, CrateTourMutationVariables>, 'mutation'>,
) => {
...
export const getListOfTours = (
	options: Omit<WatchQueryOptions<GetListOfToursQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<GetListOfToursQuery> & {
		query: ObservableQuery<GetListOfToursQuery, GetListOfToursQueryVariables>
	}
> => {
	const q = client.watchQuery({
...
export const getTour = (
	options: Omit<WatchQueryOptions<GetTourQueryVariables>, 'query'>,
): Readable<
	ApolloQueryResult<GetTourQuery> & {
		query: ObservableQuery<GetTourQuery, GetTourQueryVariables>
	}
> => {
	const q = client.watchQuery({
		query: GetTourDoc,
...
export const createTourCheckpointCompletion = (
	...
	const m = client.mutate<
		CreateTourCheckpointCompletionMutation,
		CreateTourCheckpointCompletionMutationVariables
	>({
